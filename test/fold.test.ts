...
describe('processFold', () => {
  ...
  it('should throw error if fold is invalid', () => {
    ...
    expect(() => processFold(metaLines, fold, metaLines.length)).toThrow('Invalid input: start 2 > end 1')
  })
  ...
  it('should throw error if fold is out of range', () => {
    ...
    expect(() => processFold(metaLines, fold, metaLines.length)).toThrow('Invalid input: start 2 or end 10 > length 3')
  })
})
